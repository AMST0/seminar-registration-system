...
export default function RegistrationForm({ seminarId, onSuccess }: RegistrationFormProps) {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <div 
          className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-3 sm:p-4"
        ...
        >
          ...
          <div className="relative w-full sm:max-w-md bg-white sm:rounded-3xl rounded-t-3xl shadow-2xl 
                          max-h-[88vh] sm:max-h-[90vh] overflow-hidden animate-slideUp mb-0 sm:mb-0">
            {/* Header */}
            <div className="relative px-5 sm:px-6 pt-5 sm:pt-6 pb-4 sm:pb-4 border-b border-stone-100">
              {/* Drag indicator for mobile */}
              <div className="absolute top-2.5 left-1/2 transform -translate-x-1/2 w-10 h-1 bg-stone-300 rounded-full sm:hidden" />
              
              <div className="flex items-center justify-between mt-3 sm:mt-0">
                <div>
                  <h2 className="text-xl sm:text-xl font-bold text-stone-900">Seminere Kayıt Ol</h2>
                  <p className="text-sm sm:text-sm text-stone-500 mt-1">Bilgilerinizi doldurun</p>
                </div>
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-stone-100 hover:bg-stone-200 
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="px-5 sm:px-6 py-5 sm:py-6 space-y-4 sm:space-y-4 overflow-y-auto max-h-[calc(88vh-140px)] sm:max-h-[calc(90vh-180px)]">
              {error && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-3.5 rounded-2xl border-2 border-stone-200
              ...
              <div className="pt-2">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="relative flex-shrink-0 mt-0.5">
                    ...
                    <div className="absolute inset-0 w-5 h-5 rounded-lg border-2 border-stone-300 
              ...
              {/* Security note */}
              <p className="text-center text-xs text-stone-400 pt-2 pb-3">
